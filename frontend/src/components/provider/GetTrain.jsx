  ...
  return (
    <div className="container-fluid p-3 bg-light text-primary">
      ...
      <div className="bg-light p-3 rounded">
        {trains.length === 0 ? (
          <p>No trains found for provider ID {providerId}.</p>
        ) : (
            ...
            <tbody>
              {trains.map((train) => (
                <tr key={train.trainId}>
                  ...
                  <td>₹{train.price}</td>
                  <td>{train.provider?.providerName} ({train.provider?.providerOrganization})</td>
                  <td>
                    <button className="btn btn-sm btn-primary me-2" onClick={() => handleEditClick(train)}>Update</button>
                    <button className="btn btn-sm btn-danger" onClick={() => handleDeleteClick(train)}>Delete</button>
                  </td>
                </tr>
              ))}
            </tbody>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <select className="form-select mb-2" name="trainType" value={editingTrain.trainType} onChange={handleInputChange}>
                ...
                <input className="form-control mb-2" type="datetime-local" name="arrivalTime"
                  ...
                  onChange={handleInputChange} min={new Date().toISOString().slice(0, 16)} />
                <label>Price</label>
                <input className="form-control" type="number" name="price" value={editingTrain.price} onChange={handleInputChange} />
              </div>
              <div className="modal-footer">
                <button className="btn btn-success" onClick={handleUpdateTrain}>Update</button>
        ...
        <div className="modal show d-block" tabIndex="-1">
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                Are you sure you want to delete <strong>{deleteTarget.trainName}</strong>?
              </div>
