...
var issuer = "https://www.payoda.com/";
var audience = "ticket-booking";
...
const string connectionString =
    "Data Source=PTPLL512;TrustServerCertificate=True;Integrated Security=True;Initial Catalog=TicketBooking;";

builder.Services.AddDbContext<AppDbContext>(options =>
    options.UseSqlServer(connectionString));

builder.Services.AddTransient<IUserInterface, UserServices>();
builder.Services.AddTransient<ISuperAdminInterface, SuperAdminServices>();
